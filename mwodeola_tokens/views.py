...
class TokenRotationView(TokenViewBase):
    """
    Takes a refresh type JSON web token and returns a JSON web token of
    access and refresh type if the refresh token is valid.
    """
    serializer_class = serializers.TokenRotationSerializer


token_rotation = TokenRotationView.as_view()
